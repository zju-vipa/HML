...
<!--              </el-form>-->
  ...
  <div>
    ...
    <el-tabs v-model="activeTabName" @tab-click="handleClick">
      <el-tab-pane label="最新结果" name="first"></el-tab-pane>
      <el-tab-pane label="已有特征工程" name="second"></el-tab-pane>
      <el-tab-pane label="特征库" name="third"></el-tab-pane>
    </el-tabs>
...
export default {
  data() {
    return {
      activeTabName: 'first' // 默认显示第一个选项卡的内容
    }
  },
  methods: {
