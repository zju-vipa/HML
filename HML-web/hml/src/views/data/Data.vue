...
export default {
  ...
  data () {
    return {
      ...
      crossSectionTrainingSetUploadURL: 'http://192.168.31.7:8021/api/private/v1/dataset/uploadCrossSectionTrainingSet',
      crossSectionTestSetUploadURL: 'http://192.168.31.7:8021/api/private/v1/dataset/uploadCrossSectionTestSet',
      publicOption,
      // Tab标签激活的名字
      activeName: 'upload',
      // 上传数据的表单
      ...
      uploadURL: 'http://192.168.31.7:8021/api/private/v1/dataset/upload',
      uploadFormRules: {
        dataset_name: [
