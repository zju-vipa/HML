...
def matlab_data_generation_b(file_path=None, load_list=[0.8, 1.2], fault_line_list=[1, 2], line_percentage_list=[0.1, 0.2], fault_time_list=[1, 2] **kwargs) :
    ...
    res = eng.generate_datas_function(file_path, matlab.double(load_list),matlab.double(fault_line_list),matlab.double(line_percentage_list),matlab.double(time_list))
