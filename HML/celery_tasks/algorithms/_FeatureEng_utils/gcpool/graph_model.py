...
from celery_tasks.algorithms._FeatureEng_utils.gcpool.mlp import MLP
from torch.autograd import Variable
from celery_tasks.algorithms._FeatureEng_utils.gcpool.cov_norm import FastMPNSPDMatrix
from flask import current_app


class GraphCNN(nn.Module):
    def __init__(self, num_layers, num_mlp_layers, input_dim, hidden_dim, output_dim, fac_dim, rep_dim, final_dropout,
                 learn_eps,
        ...
        self.feature_norm = torch.nn.BatchNorm1d(input_dim)
    ...
    def forward(self, batch_graph):
        ...
        # X_concat = self.feature_norm(X_concat)
        ...
        feature_last_layer = torch.split(feature_last_layer, graph_sizes, dim=0)
        ...
        self.batch_fo = batch_fo
        self.batch_so = batch_so
