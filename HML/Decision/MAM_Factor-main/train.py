...
#from q_table import run_q_table
import os
import shutil
...
if __name__ == '__main__':
    ...
    train(get_args())
    while(1):
      if (os.path.exists("/root/HML/Decision/MAM_Factor-main/log/M5case118/MAMAttention/policy.pth")):
    #   if (os.path.exists("log/M5case118/MAMAttention/policy.pth")):
         from q_table import run_q_table
         run_q_table()
         break
    ...
    #             policy_path = os.path.join(log_dir, sub_dir, "MAMAttention/policy.pth")
