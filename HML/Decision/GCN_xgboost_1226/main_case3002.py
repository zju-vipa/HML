...
from utils_ps2 import load_psdata
...
def main():
    ...
    path_ = str('state/')+str(args.dataset) + '_' + str(args.fold_idx) +'_' + str(args.batch_size) + '_'+ str(args.hidden_dim) + '_'+  str(args.lr) + 'x2_.pth'
