...
from utils_ps5 import load_psdata
...
def main():
    ...
    path_ = str('state/')+str(args.dataset) + '_' + str(args.fold_idx) +'_' + str(args.batch_size) + '_'+ str(args.hidden_dim) + '_'+  str(args.lr) + 'x5_.pth'
    ...
    # path = "C:/Users/yj/Desktop/GCN_xgboost/state/CASE300_0_32_32_0.001_.pth"
    #
    # print("开始导入图网络深度模型...")
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        print("performance F1, acc, tnr, tpr : %f %f %f %f" % (max_F1, max_acc, max_tnr, max_tpr))

        print("")

        print(model.eps)

    torch.save(max_model, path_)
