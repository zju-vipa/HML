...
def main():
    ...
    path = "/disk1/zyh/decision_tree/state/CASE300_0_32_32_0.001x4_.pth"
    '''
    print("开始导入图网络深度模型...")
...
def generate_path_images(decision_tree, path, feature_names=None, folder_name='case4/decision_path_steps'):
    # 创建保存图像的文件夹
